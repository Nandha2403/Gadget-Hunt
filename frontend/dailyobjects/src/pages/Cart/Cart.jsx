		...
		<Box width="100%">
			<Box marginTop="100px">
				<Heading textAlign="center" marginBottom="5">
					Shopping Bag{" "}
					<Badge colorScheme="green" borderRadius="full" px="3" py="2">
						{items}
					</Badge>
				</Heading>
			</Box>
			...
			<Box shadow="sm" w="85%" margin="auto">
				<Flex
					h={{ base: "500px", md: "350px", sm: "200px", xs: "140px" }}
					padding="0.5rem"
				...
				>
					...
					<Box flex="1">
						<Flex
							w={{ base: "70%", md: "70%", sm: "100%" }}
							h="auto"
							marginLeft={{ base: "150px", md: "100px", sm: "0px" }}
							marginTop="50px"
						>
							<VStack w={{ base: "90%", sm: "100%" }}>
								...
								>
									<HStack w="100%">
										<Image
											padding="0.2rem"
											src="https://www.invoguespa.com/wp-content/uploads/2018/01/giftcard.jpg"
											maxW="20%"
										></Image>
										<Input
										...
										></Input>
										<Button bg="teal.200" onClick={() => handleGiftCard}>
											Apply
										</Button>
									</HStack>
								</Box>
					...
					<Modal onClose={onClose} isOpen={isOpen} isCentered>
						...
						<ModalContent>
							...
							<ModalBody>
								...
								<Text color="blue.300">
									{" "}
									Use code 'masai30' to get 30% discount on cart total.{" "}
								</Text>
								<br></br>
