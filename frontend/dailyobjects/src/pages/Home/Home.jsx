...
import NavigatetoTop from "../../components/NavigateTop/NavigatetoTop";
                    ...
                    <div className="collec_card_wrap">
                        ...
                        <div>
                            ...
                            <div style={{ padding: "0px 10px" }}>
                                ...
                                <Text>
                                    Urban-Inspired carriers, made for
                        ...
                        <div>
                            ...
                            <div style={{ padding: "0px 10px" }}>
                                ...
                                <Text>
                                    Designed with minimal geometric innovtions
                                    to add comfort to your workspace.
                                </Text>
                                <Button
                                    color={"black"}
                                    variant={"link"}
                    ...
                    <div className="collec_card_wrap">
                        <div>
                            ...
                            <div style={{ padding: "0px 10px" }}>
                                ...
                                <Text>
                                    A vivid dream journal that lets you carry
                                    your daydreaming stance into real life.
                                </Text>
                                <Button
                                    color={"black"}
                                    variant={"link"}
